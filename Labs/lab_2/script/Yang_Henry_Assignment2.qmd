...
options(tigris_use_casche = TRUE)
options(tigris_process = FALSE)
```
...
# Load spatial data
pa_counties <- counties(state = "PA", cb = TRUE, progress = FALSE)
pa_tracts <- tracts(state = "PA", cb = TRUE, progress = FALSE)
...
polling <- st_read(here("data", "polling_places.geojson"), quiet = TRUE)
bus <- st_read(here("data", "septa_bus.geojson"), quiet = TRUE)
metro <- st_read(here("data", "septa_metro.geojson"), quiet = TRUE)
rail <- st_read(here("data", "septa_rail.geojson"), quiet = TRUE)
trolley <- st_read(here("data", "septa_trolley.geojson"), quiet = TRUE)

phl_tracts <- tracts(state = "PA", county = "Philadelphia", cb = TRUE, progress = FALSE)
...
polling <- st_transform(polling, 3365, quiet = TRUE)
septa_stops <- st_transform(septa_stops, 3365, quiet = TRUE)
phl_tracts_acs <- st_transform(phl_tracts_acs, 3365, quiet = TRUE)
